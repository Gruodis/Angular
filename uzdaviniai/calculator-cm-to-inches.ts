...
let numInch = document.getElementById("num_X") as HTMLInputElement;
...
// let geometrija = {
let cmToInch: Duomenys = { // objektas - cmToInch, objekto tipas - Duomenys. Jeigu nenurodome objekto tipo, nematysime praleisto atributo klaidos
    x: parseInt(numInch.value),

}
// console.log("geometrija", vykdom(cmToInch));

const vykdom = (p: Duomenys) => {
    return p.x / 2.54;
